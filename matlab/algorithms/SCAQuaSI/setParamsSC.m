function [params,f_new_vec,Down,DownT,E,grad,v_vec,bv_vec,u_vec,bu_vec,L] = setParamsSC(g,params)
...
[Rn,Cn,Dim] = size(g);
[R,C,D] = size(params.guide);
params.R = R;
params.C = C;

if Dim~=1 || D~=1
    error('Single-channel approach -> please use admmMC!')
end
